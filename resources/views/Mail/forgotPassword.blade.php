...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2 style="text-align: center;"><strong>OTP : </strong>{{ $Otp['otp'] }}</h2>
            <p><a href="{{ url('https://budgetbuddy.buddyledtv.com/public/createNewPassword') }}" class="button">Change Password</a></p>
