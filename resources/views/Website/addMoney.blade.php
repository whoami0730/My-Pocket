...
<body>
    ...
    @section('main')
        ...
        <div class="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="{{ route('credit') }}" method="post" class="form-horizontal" id="my-form">@csrf
                        <div class="card">
                                                    ...
                                                    <div class="col-6 col-sm-4 col-lg-2">
                                                        <div class="card">
                                                            <div class="card-body p-3 text-center">
                                                                ...
                                                                <div class="h2 m-0">₹ {{ $wallet->balance }}</div>
                                                                <div class=" h6 text-muted mb-3 text-capitalize">
                                                                    {{ $wallet->wallet_name }}
                                                                </div>
                                                            </div>
                                                        </div>
